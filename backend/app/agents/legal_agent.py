...
class LegalAgent:
    ...
    def decide_and_act(self, user_query: str, session_id: str) -> dict:
        # Step 1: Soft classification (signal only)
        classification = self.classifier.classify(user_query)

        # Step 2: Retrieve candidate laws
        raw_sources = self.rag.search_legal_knowledge(user_query)
        ...
        # Step 4: Inject memory context into LLM reasoning
        ...
        llm_response = generate_llm_response(
            user_query=memory_str + user_query,
